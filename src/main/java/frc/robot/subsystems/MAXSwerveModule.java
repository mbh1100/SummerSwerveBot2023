...
public class MAXSwerveModule {
  ...
  public MAXSwerveModule(int drivingCANId, int turningCANId, double chassisAngularOffset) {
    ...
    // APIs.
    m_turningEncoder.setPositionConversionFactor(Constants.kTurningEncoderPositionFactor);
    m_turningEncoder.setVelocityConversionFactor(Constants.kTurningEncoderVelocityFactor);

    // Invert the turning encoder, since the output shaft rotates in the opposite direction of
    // the steering motor in the MAXSwerve Module.
    m_turningEncoder.setInverted(Constants.kTurningEncoderInverted);
    ...
    m_turningPIDController.setPositionPIDWrappingMinInput(Constants.kTurningEncoderPositionPIDMinInput);
    m_turningPIDController.setPositionPIDWrappingMaxInput(Constants.kTurningEncoderPositionPIDMaxInput);
    ...
    m_turningPIDController.setFF(Constants.kTurningFF);
    m_turningPIDController.setOutputRange(Constants.kTurningMinOutput,
